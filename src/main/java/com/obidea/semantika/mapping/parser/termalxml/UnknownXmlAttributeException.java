...
public class UnknownXmlAttributeException extends MappingParserException
{
   private static final long serialVersionUID = 629451L;

   public UnknownXmlAttributeException(String message, int lineNumber, int columnNumber)
   {
