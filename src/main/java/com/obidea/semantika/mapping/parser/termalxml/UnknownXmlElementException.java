...
public class UnknownXmlElementException extends MappingParserException
{
   private static final long serialVersionUID = 629451L;

   public UnknownXmlElementException(String message, int lineNumber, int columnNumber)
   {
