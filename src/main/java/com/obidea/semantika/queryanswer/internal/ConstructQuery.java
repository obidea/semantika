 ...
 * @since 1.8
 */
public class ConstructQuery extends QueryBase
{
   public ConstructQuery(String sparqlString, SparqlQueryEngine engine) throws QueryParserException
   {
      super(sparqlString, engine);
   }

   public ConstructQuery setMaxResults(int limit)
   {
      mQueryModifiers.setLimit(limit);
      return this;
   }

   public ConstructQuery setFirstResult(int offset)
   {
      mQueryModifiers.setOffset(offset);
      return this;
   }

   public ConstructQuery setAscendingOrder(String column)
   {
      mQueryModifiers.setAscendingOrder(column);
      return this;
   }

   public ConstructQuery setDescendingOrder(String column)
   {
