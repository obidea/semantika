...
public class SourceQueryParsingException extends MappingParserException
{
   private static final long serialVersionUID = 629451L;

   public SourceQueryParsingException(String message, int lineNumber, int columnNumber)
   {
