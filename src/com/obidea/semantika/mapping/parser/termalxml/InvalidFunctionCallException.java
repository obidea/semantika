...
public class InvalidFunctionCallException extends MappingParserException
{
   private static final long serialVersionUID = 629451L;

   public InvalidFunctionCallException(String message, int lineNumber, int columnNumber)
   {
