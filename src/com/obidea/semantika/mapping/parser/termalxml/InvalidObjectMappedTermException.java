...
public class InvalidObjectMappedTermException extends InvalidMappedTermException
{
   private static final long serialVersionUID = 629451L;

   public InvalidObjectMappedTermException(Term term)
   {
      super(term);
   }
   ...
   {
      return String.format("Object map doesn't accept %s (%s)", //$NON-NLS-1$
