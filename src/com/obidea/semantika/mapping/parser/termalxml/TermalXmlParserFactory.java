...
public class TermalXmlParserFactory implements IMappingParserFactory
{
   @Override
   public IMappingParser createParser(IMetaModel metaModel)
   {
      return new TermalXmlParser(metaModel);
   }
}
