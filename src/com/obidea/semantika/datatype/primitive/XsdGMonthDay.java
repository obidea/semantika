...
public class XsdGMonthDay extends AbstractTimelineType
{
   private static final XsdGMonthDay mInstance;

   static {
      mInstance = new XsdGMonthDay();
   }
   ...
   {
      super(DataType.G_MONTH_DAY, javax.xml.datatype.DatatypeConstants.GMONTHDAY);
   }
   ...
   public int getType()
   {
      return DataTypeConstants.G_MONTH_DAY;
   }
}
