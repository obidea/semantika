...
public class XsdNonPositiveInteger extends AbstractDerivedDecimalType
{
   private static final XsdNonPositiveInteger mInstance;

   static {
      mInstance = new XsdNonPositiveInteger();
   }
   ...
   {
      super(DataType.NON_POSITIVE_INTEGER);
   }
   ...
   public int getType()
   {
      return DataTypeConstants.NON_POSITIVE_INTEGER;
   }

   @Override
   public String toString()
   {
      return "xsd:nonPositiveInteger"; //$NON-NLS-1$
   }
}
